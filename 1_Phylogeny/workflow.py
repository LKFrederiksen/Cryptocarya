...
# Edited by Laura Kragh Frederiksen 14/02/2023
# ----------------------------------------------------------------------------------------------------------------------------
# ----------------------------------------------------------------------------------------------------------------------------
# This workflow includes 3 workflows: 
# 1. Workflow to reconstruct the Final species tree, using supercontings in the ingroup and a combination of exon and aupercontigs in the outgroup to reconstruct the PAFTOL topology.
# 2. Workflow to determine how to reconstruct the outgroup topology.
# 3. Workflow to choose suitable genes for molecular dating in BEAST.
...
# Run the script optrimal.R in interactive mode from the folder 10_trimal where the summary files generated in the 2 amas scripts are, if the R environment does not work.
...
# # First manually copy partition files to path_out
