...
# Dropping tips of twelth species where I have multiple samples. Removing the tips with the most gaps in the alignments: Synd-marli-777AL1, Pota-obtus-771AL1, Cryp-spath-790AL1, Cryp-polyn-782AL1, Cryp-pervi-781AL1, Cryp-litor-734AL1, Cryp-alba-PAFTOL, Beil-tawa-724AL1, Beil-tarai-722AL1, Beil-roxbu-716AL1, Beil-manni-705AL1, Beil-manni-706AL1, Beil-latif-700AL1.
startingtree <- drop.tip(phy = startingtree, tip = c(71,55,128,136,131,135,95,61,56,82,43,44,74))
startingtree[["tip.label"]]
