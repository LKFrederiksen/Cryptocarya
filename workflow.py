...
def move(path_exons, path_partition, gene, gene_select, path_out):
    """ move """
    inputs = [path_exons, path_partition]
    outputs = [path_out+gene]
    ...
    """.format(path_exons = path_exons, gene = gene, path_out = path_out, path_partition = path_partition, gene_select = gene_select)
