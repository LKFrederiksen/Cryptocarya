...
def hybpiper_outgroup(name, p1, p2, un, path_out, path_in, done):
    ...
    cp --recursive --update {name} /home/laurakf/cryptocarya/Workflow/PAFTOL/06_HybPiper/Outgroup/
...
def hybpiper_ingroup(name, p1, p2, un, path_out, path_in, done):
    ...
    cp --recursive --update {name} /home/laurakf/cryptocarya/Workflow/PAFTOL/06_HybPiper/Ingroup/
...
# # I have removed Endi_latif which turned out not to be correctly identified. It is not a Lauraceae, the sample has a serrated leaf margin. 
