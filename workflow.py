...
def gene(path_exons, path_partition, gene, path_out):
    """ move """
    inputs = [path_partition]
    outputs = [path_out+gene+"_part.txt.treefile", done]
...
#Running move commands.                                           
for i in range(0, len(gene)):
   gwf.target_from_template('gene_'+gene[i], gene(gene = gene[i],
                                                    path_out = "/home/laurakf/cryptocarya/Workflow/PAFTOL-partitions/20_Astral-mix/10/",
                                                    path_partition = "/faststorage/project/cryptocarya/Workflow/PAFTOL-partitions/19_sortadate/gene_trees/",
...
for i in range(0, len(gene_select)):
   gwf.target_from_template('gene_select_'+gene[i], gene_select(gene_select = gene_select[i],
                                                    path_out = "/home/laurakf/cryptocarya/Workflow/PAFTOL-partitions/20_Astral-mix/10/",
