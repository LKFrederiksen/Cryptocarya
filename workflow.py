...
for i in range(0, len(gene)):
    ...
    gwf.target_from_template('Root_'+gene[i], root_genetrees(gene = gene[i],
                                                        path_out = "/home/laurakf/cryptocarya/Workflow/PAFTOL-exons/17_IQtree_geneTrees/rooted_geneTrees/",
                                                        path_in = "/home/laurakf/cryptocarya/Workflow/PAFTOL-exons/17_IQtree_geneTrees/"))
