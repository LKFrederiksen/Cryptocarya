...
def exon_mapper(path_in, path_out, done, gene):
    """Aligning all the sequences for each gene."""
    path_ins = [path_in+gene+"_aligned.fasta"]
    outputs = [done] 
    options = {'cores': 4, 'memory': "4g", 'walltime': "1:00:00", 'account':"cryptocarya"}
    ...
    python3 /home/laurakf/cryptocarya/Scripts/exon_mapper.py

    echo touching {done}

    touch {done}

    """.format(done = done, path_in = path_in, path_out = path_out, gene = gene)
...
#                                                         path_out= "/home/laurakf/cryptocarya/Workflow/PAFTOL-partitions/09_Mafft/",
#                                                         path_in = "/home/laurakf/cryptocarya/Workflow/PAFTOL/08_Retrieve/",
#                                                         gene = gene[i],
#                                                         done = "/home/laurakf/cryptocarya/Workflow/PAFTOL-partitions/09_Mafft/done/"+genes[i]))

#### EXON MAPPER
gwf.target_from_template('Exon_Mapper_', exon_mapper(path_out= "/home/laurakf/cryptocarya/Workflow/PAFTOL-partitions/09_Mafft/",
                                                    path_in = "/home/laurakf/cryptocarya/Workflow/PAFTOL-partitions/09_Mafft/",
                                                    gene = gene[i],
                                                    done = "/home/laurakf/cryptocarya/Workflow/PAFTOL/09_Mafft/done/exon/exon"))
